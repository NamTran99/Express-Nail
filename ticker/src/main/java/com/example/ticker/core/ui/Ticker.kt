...
class Ticker @JvmOverloads constructor(
    ...
    private fun initViews() {
        ...
        binding.tvAm.setOnClickListener {
            isAmSelected = true
            binding.tvAm.setTextColor(ResourcesCompat.getColor(resources, R.color.time_unit_selected_color, null))
            binding.tvPm.setTextColor(ResourcesCompat.getColor(resources, R.color.time_unit_unselected_color, null))
        }
        binding.tvPm.setOnClickListener {
            isAmSelected = false
            binding.tvPm.setTextColor(ResourcesCompat.getColor(resources, R.color.time_unit_selected_color, null))
            binding.tvAm.setTextColor(ResourcesCompat.getColor(resources, R.color.time_unit_unselected_color, null))
        }
        if (isAmSelected) {
    ...
    private fun scrollToCurrentTime(rv: RecyclerView, isHours: Boolean) {
        val scrollRunnable = if (isHours) {
            ...
            val currentTimeIntPosition = currentlySelectedMinute.toIntOrNull()?.div(minutesInterval)
