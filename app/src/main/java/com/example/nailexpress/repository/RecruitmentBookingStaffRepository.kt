    ...
    suspend fun createRecruitment(form: RecruitmentForm, salon: Salon, isShowSalon: Boolean): Int? {
        ...
        return api.createRecruitment(
            RequestBodyBuilder()
                ...
                .putIf(form.isSelectBookingService,"salary_by_skill", form.listBookSkill.toString())
                .putIf(form.isSelectBookingTime,"salary_by_time", form.listBookTime.toString())
                .putIf(form.isSelectBookingTime,"salary_time_values", form.salaryTimeValue.toString())
